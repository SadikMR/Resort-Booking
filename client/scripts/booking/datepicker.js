...
class HotelDatepicker {
  ...
  addListeners() {
    ...
    if (this.showTopbar && !this.inline && this.topbarCloseButton) {
  ...
  createDatepickerDomString() {
    ...
    if (!this.inline && this.topbarCloseButton) {
  ...
  showSelectedInfo() {
    ...
    const closeButton = this.topbarCloseButton ? document.getElementById(this.getCloseButtonId()) : null;
    const clearButton = document.getElementById(this.getClearButtonId());
    const submitButton = document.getElementById(this.getSubmitButtonId());
    ...
    if (this.start && this.end) {
      ...
      if (!this.inline) {
        ...
        if (this.submitButton && submitButton) {
